label capitulo1:
    ...
    with dissolve
    wr" Excuse me, Officer. I was trying to finish sorting these documents."
    wr "Yes, I was looking for you. I’m sorry to call you out at this hour, but something suddenly came up. Were you leaving already?"
    md worrid"{i}Inspector looked worn out.{/i}"
    ...
    show victoria smile
    with dissolve
    wr "Well then, I guess It can't be helped. See you tomorrow, Officer Reilly."
...
label leave:
    md "Okay. I guess... We can continue this conversation tomorrow."
    wr "Yeah. Take care, Officer Reilly"
    md "{i}For some reason I feel horrible now.{/i}"
    md "..."
    pause 1
    scene black with Dissolve(4.0,hard=True)
    play sound "audio_footsteps_normal.ogg"
    ...
    with dissolve
    pause 1
    mdpov "{i}I walk towardars the door disappointedly.{/i}"
    mdpov "{i}It's not like I lied to her, right?{/i}"
    mdpov "{i}It's true I have plans tonight... Though... Are they really that important?{/i}"
    mdpov "{i}I can't forget the vision of that sad smile of hers.{/i}"
    mdpov "{i}Gosh! Get out my head already!{/i}"
    ...
    mdpov "{i}I anxiosly run back to the office.{/i}"
    pause 1
    scene black with Dissolve(4.0,hard=True)
    play sound "audio_footsteps_normal.ogg"
    scene bg_comisaria
    ...
    show victoria surprised
    with dissolve
    wr "Oh! Did you forget something?"
    md fool"{i}She's all surprised. Look at my commitment Victoria! I foolishly fantasize.{/i}"
    wr "Detective?"
    md shy"I was thinking..."
    pause 2
    md normal"My plans weren't that important after all."
    show victoria okay
    with dissolve
    wr "I see..."
    ...
    show victoria normal
    with dissolve
    wr "As you wish then. I'm..."
    pause 1
    show victoria smile
    with dissolve
    wr "I'm happy you stayed."
    jump continuar
...
label stay:
    ...
    md worried"{i}And Charlene will probably kill me for this but...{/i}"
    show victoria surprised
    with dissolve
    wr "Is anything wrong? You'll  be late."
    md normal"I was thinking...My plans weren't that important after all."
    show victoria thinking
    with dissolve
...
label continuar:
    ...
    show victoria normal
    with dissolve
    wr "Then...May I ask you to come to my office?"
    ...
    md huh"{i}Two years working here and she still calls me Detective Reilly...{/i}"
    md fool"{i}Is Jeff that hard to say?{/i}"
    pause 1
    ...
    md thinking"Any pshycho could have written something like that... The new has been published and broadcasted all over the country.{w=0.7} It can just be a nasty joke..."
    show victoria thinking
    with dissolve
    wr "That's the first think I though..."
    md doubt"..."
    show victoria serious
    with dissolve
    wr "Obviously an anonymous mail without any type of real evidence it's not enough to open an investigatio, right?"
    wr "Here."
    ...
    show victoria worried
    with dissolve
    wr "I spent the last four hours trying to unravel wether they are real or not."
